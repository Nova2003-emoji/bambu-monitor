...
#ifndef _GxEPD2_420_Z96_H_
#define _GxEPD2_420_Z96_H_

#include "../GxEPD2_EPD.h"

class GxEPD2_420_Z96 : public GxEPD2_EPD
{
  public:
    // attributes
    ...
    // constructor
    GxEPD2_420_Z96(int8_t cs, int8_t dc, int8_t rst, int8_t busy);
    // methods (virtual)
	...
	uint8_t grayScale = 3; //灰度等级 0白色 1浅灰 2深灰 3黑色
	void setGrayscale(uint8_t gray); //设置灰度等级 0白色 1浅灰 2深灰 3黑色
  ...
  private:
	...
	void _SetGrayscale(uint8_t gray); //设置灰度等级 0白色 1浅灰 2深灰 3黑色
	
  private:
    static const uint8_t LUT_DATA_full[];
    static const uint8_t LUT_DATA_part_gray3[];
	static const uint8_t LUT_DATA_part_gray2[];
	static const uint8_t LUT_DATA_part_gray1[];
};
